...
DOCKER_PHP_EXT_INSTALL="bcmath bz2 calendar dba exif gd gettext iconv imap intl mbstring mcrypt mysqli opcache pdo_dblib pcntl pspell soap sockets xmlrpc xsl zip"
