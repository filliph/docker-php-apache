...
DOCKER_PHP_EXT_INSTALL="bcmath bz2 calendar dba exif gd gettext gmp iconv imap intl mbstring mysqli pdo_mysql pcntl pspell soap sockets xsl zip"
...
#eval "pickle install imagick"
eval "pickle install apcu"
eval "pickle install igbinary"
eval "pickle install memcached"
#eval "pickle install redis"
#eval "pickle install xdebug"
#eval "docker-php-ext-enable imagick"
eval "docker-php-ext-enable apcu"
eval "docker-php-ext-enable igbinary"
eval "docker-php-ext-enable memcached"
#eval "docker-php-ext-enable redis"
#eval "docker-php-ext-enable xdebug"
/tmp/build_apache.sh
